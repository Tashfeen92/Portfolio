...
import { android, design, mern, photography, presentation, research, service } from "../assets/txts"
  ...
  return (
    <Box  padding={10}>
            ...
            spacing={6}>
                ...
                <Card bgGradient={gradient} borderRadius={'30px'}>
                <CardBody >
                <GiArchiveResearch size={50} style={{color:'#e64d27' ,margin:'auto'}}/>
                <br></br>
              ...
              <Card bgGradient={gradient} borderRadius={'30px'}>
              <CardBody>
              <SiAndroidstudio size={50} style={{color:'#24c90e' ,margin:'auto'}}/>
              <br></br>
              <Heading fontSize={'15px'} >Android Development</Heading>
                ...
                <Card bgGradient={gradient} borderRadius={'30px'}>
                <CardBody>
                <RiPresentationFill size={50} style={{color:'#f241bd' ,margin:'auto'}}/>
                <br></br>
